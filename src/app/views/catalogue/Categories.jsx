...
const Categories = () => {
    ...
    let sortableColumn = [
        ...
        },
        {
            ...
            text: "Image",
            formatter: (cell, row, index) => {
                return <img  onError={common.addDefaultSrc} className="zoom" style={{ width: '50px', height: '50px' }} src={process.env.PUBLIC_URL + '/category/' + row.filename} alt="" />;
            },
            classes: 'text-center',
            editable: false,
            sort: false
        ...
        <Button
            ...
            onClick={(e) => {
                ...
                setCategory({
                    ...
                    category: '',
                    filename: '',
                    sequence: categoryList[(categoryList.length - 1)] ? (parseInt(categoryList[(categoryList.length - 1)].sequence) + 1) : 1,
                    description: '',
                    status: 1,
                })
                setImageUrl('')
    ...
    return (
        <div>
            <Breadcrumb
                routeSegments={[
                    { name: "Dashboard", path: "/" },
                    { name: "Catalog", path: "/catalogue/categories" },
                    { name: "Categories" }
                ]}
            />
